    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your thoughts,track your moods,and reflect, and reflect on
          your journey in a beautiful, secure space
        </p>
          ...
          <div className="bg-white rounded-2xl p-4 max-full mx-auto">
            ...
            <div className="space-y-4 p-4">
              <h3 className="text-xl font-semibold text-orange-900">
                {advice ? advice : "My thoughts todays"}
              </h3>
      ...
      <section
        id="features"
        className="mt-24 grid md:grid-col-2 lg:grid-cols-3 gap-8"
      >
          ...
          {faq.map((faq, index) => {
            return (
              <AccordionItem key={faq.q} value={`item-${index}`}>
                <AccordionTrigger className="text-orange-900 text-lg">{faq.q}
                </AccordionTrigger>
        ...
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-orange-700 mb-8 max-w-2xl mx-auto">
              Join thousands of writers who have already discoverd the power of digital journaling
            </p>
